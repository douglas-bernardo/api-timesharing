...
WHERE
        ...
        AND TO_DATE(TO_CHAR(O.DTOCORRENCIA,'dd/mm/yyyy'), 'dd/mm/yyyy') >= TO_DATE('01/07/2020', 'dd/mm/yyyy')
        -- AND O.IDOCORRENCIA > PARAM_LAST_OCORRENCIA_ID -- LAST_OCORRENCIA_ID ex 348813 -> 244rows
        -- PARAM_FILTER
